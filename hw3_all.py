...
# ВОПРОС: Вот здесь какой написать select запрос , чтобы вывести информацию есть ли такая запись уже в базе
...
# ВОПРОС: Вот здесь какой написать join запрос, чтобы сформировать join таблицу с зависимостью комментариев
